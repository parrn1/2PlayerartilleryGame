...
public class clear : MonoBehaviour {
	...
	void Start () 
	{
		...
		checkX = arrayMap.targetX;
		checkY = arrayMap.targetY;
	}

	// Update is called once per frame
	void Update () 
	{
		if (arrayMap.mapArray [checkX, checkY] < 1) 
		{
			Debug.Log (arrayMap.mapArray [checkX, checkY]);
			win = true;
			arrayMap.mapArray [checkX, checkY] = 2;
